...
export function AirportSelector({ airports, initialFrom, initialTo, onSubmit }: AirportSelectorProps) {
	...
	return (
		<div className="mx-auto" style={{ maxWidth: 480 }}>
			<div className="text-center mb-4">
				...
				<p className="text-muted mb-0">Choose your departure and destination airports</p>
			</div>
			...
			<Form>
				...
				<div className="d-flex justify-content-end">
					<Button onClick={() => onSubmit(from, to)} disabled={!from || !to} size="lg" className="px-4">
						Continue to dates
					</Button>
				</div>
			</Form>
